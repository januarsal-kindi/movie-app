...
interface CardProps extends PropsWithChildren<any>{
    onClickImage:(urlImage:string) => void,
    ...
    return (
        <>
            <div className="cursor-pointer max-w-sm bg-white shadow-lg rounded-lg overflow-hidden my-4">
                <img className="w-full h-56 object-cover object-center cursor-pointer"
                    src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80"
                    alt="avatar"
                    onClick={() => props.onClickImage('https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80')}
                />
